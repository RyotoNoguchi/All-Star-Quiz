...
export const GAME_CONFIG = {
  ...
  RULES: {
    ...
    ELIMINATION_ON_SLOWEST_CORRECT: true,
    ANSWER_WINDOW_MS: 10_000,
    ANSWER_DEADLINE_EXCLUSIVE: true,
    TIE_BREAKER: 'server_acceptance_sequence',
    SINGLE_SURVIVOR_ADVANCES: true,
    FINAL_BELL_PHASE: 'results',
