...
export const Dialog: FC<ComponentProps<typeof DialogPrimitive.Root>> = ({
  ...props
}) => {
  return <DialogPrimitive.Root data-slot="dialog" {...props} />
}

export const DialogTrigger: FC<ComponentProps<typeof DialogPrimitive.Trigger>> = ({
  ...props
}) => {
  return <DialogPrimitive.Trigger data-slot="dialog-trigger" {...props} />
}

export const DialogPortal: FC<ComponentProps<typeof DialogPrimitive.Portal>> = ({
  ...props
}) => {
  return <DialogPrimitive.Portal data-slot="dialog-portal" {...props} />
}

export const DialogClose: FC<ComponentProps<typeof DialogPrimitive.Close>> = ({
  ...props
}) => {
